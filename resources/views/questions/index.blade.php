            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h2>All Questions</h2>
                        <div class="ml-auto">
                            <a href="{{route('questions.create')}}"><button class="btn btn-outline-secondary">Ask Question</button></a>
                        </div>
                    </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-auto">
                                     <a href="{{route('questions.edit',$question->id)}}"><button class="btn btn-outline-info">Edit</button></a>
